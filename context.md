...
| Papel | Descrição |
|-------|-----------|
| `admin` | Publica comunicados diretamente, aprova/rejeita publicações do grêmio, gerencia usuários e resolve conflitos |
| `gremio` | Cria comunicados que entram em fila de aprovação. Só publica após aprovação da adm |
| `aluno` | Visualiza comunicados do seu perfil, confirma/desmarca presença, acessa agenda pessoal |

> A permissão do grêmio pode ser desativada globalmente por um admin nas configurações do sistema.
